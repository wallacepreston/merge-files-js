...
const readTwoWriteOne = (readFrom1, readfrom2, writeTo) => {
  ...
  .forEach(
    function(currFile) {
      //read the current file in the array, defining the file type as utf-8 (used in our text files), and tell it what to do (callback)
       fs.readFile(
        currFile, 'utf-8', function(readErr, fileData) {
          // error handling
